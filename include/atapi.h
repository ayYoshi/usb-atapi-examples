...
// requests 95 bytes of Inquiry data. The array of data passed in is expected to
// be 95 bytes of length. Inquiry valid if RC is 0
...
// If TOC read with MSF format, set MSF flag. Invalid/shortened TOC data may result in a segfault
